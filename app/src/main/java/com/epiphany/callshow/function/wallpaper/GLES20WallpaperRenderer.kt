...
import com.epiphany.callshow.function.wallpaper.WallpaperHelper.compileShaderResourceGLES20
import com.epiphany.callshow.function.wallpaper.WallpaperHelper.linkProgramGLES20
    ...
    override fun onSurfaceCreated(gl10: GL10, eglConfig: EGLConfig) {
        ...
        program = linkProgramGLES20(
            compileShaderResourceGLES20(
                getContext(), GLES20.GL_VERTEX_SHADER, R.raw.vertex_20
            ),
            compileShaderResourceGLES20(
                getContext(), GLES20.GL_FRAGMENT_SHADER, R.raw.fragment_20
            )
        )
