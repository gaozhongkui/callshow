...
import com.epiphany.callshow.function.wallpaper.WallpaperHelper.compileShaderResourceGLES30
import com.epiphany.callshow.function.wallpaper.WallpaperHelper.linkProgramGLES30
...
class GLES30WallpaperRenderer(context: Context) : GLWallpaperRenderer(context) {
    ...
    override fun onSurfaceCreated(gl10: GL10, eglConfig: EGLConfig) {
        ...
        program = linkProgramGLES30(
            compileShaderResourceGLES30(
                getContext(), GLES30.GL_VERTEX_SHADER, R.raw.vertex_30
            ),
            compileShaderResourceGLES30(
                getContext(), GLES30.GL_FRAGMENT_SHADER, R.raw.fragment_30
            )
        )
