...
public class ShimmerFrameLayout extends FrameLayout {
    ...
    public ShimmerFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                if (a.hasValue(R.styleable.ShimmerFrameLayout_auto_start1)) {
                    setAutoStart(a.getBoolean(R.styleable.ShimmerFrameLayout_auto_start1, false));
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_base_alpha1)) {
                    setBaseAlpha(a.getFloat(R.styleable.ShimmerFrameLayout_base_alpha1, 0));
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_duration1)) {
                    setDuration(a.getInt(R.styleable.ShimmerFrameLayout_duration1, 0));
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_repeat_count1)) {
                    setRepeatCount(a.getInt(R.styleable.ShimmerFrameLayout_repeat_count1, 0));
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_repeat_delay1)) {
                    setRepeatDelay(a.getInt(R.styleable.ShimmerFrameLayout_repeat_delay1, 0));
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_repeat_mode1)) {
                    setRepeatMode(a.getInt(R.styleable.ShimmerFrameLayout_repeat_mode1, 0));
                }

                if (a.hasValue(R.styleable.ShimmerFrameLayout_angle1)) {
                    int angle = a.getInt(R.styleable.ShimmerFrameLayout_angle1, 0);
                    switch (angle) {
                        default:
                        case 0:
                ...
                if (a.hasValue(R.styleable.ShimmerFrameLayout_dropoff1)) {
                    mMask.dropoff = a.getFloat(R.styleable.ShimmerFrameLayout_dropoff1, 0);
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_fixed_width1)) {
                    mMask.fixedWidth = a.getDimensionPixelSize(R.styleable.ShimmerFrameLayout_fixed_width1, 0);
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_fixed_height1)) {
                    mMask.fixedHeight = a.getDimensionPixelSize(R.styleable.ShimmerFrameLayout_fixed_height1, 0);
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_intensity1)) {
                    mMask.intensity = a.getFloat(R.styleable.ShimmerFrameLayout_intensity1, 0);
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_relative_width1)) {
                    mMask.relativeWidth = a.getFloat(R.styleable.ShimmerFrameLayout_relative_width1, 0);
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_relative_height1)) {
                    mMask.relativeHeight = a.getFloat(R.styleable.ShimmerFrameLayout_relative_height1, 0);
                }
                if (a.hasValue(R.styleable.ShimmerFrameLayout_tilt1)) {
                    mMask.tilt = a.getFloat(R.styleable.ShimmerFrameLayout_tilt1, 0);
                }
            } finally {
                a.recycle();
            }
