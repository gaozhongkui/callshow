...
import com.epiphany.jextractor.cipher.CachedCipherFactory;
import com.epiphany.jextractor.cipher.Cipher;
import com.epiphany.jextractor.cipher.CipherFactory;
import com.epiphany.jextractor.extractor.DefaultExtractor;
import com.epiphany.jextractor.extractor.Extractor;
import com.epiphany.jextractor.model.Itag;
import com.epiphany.jextractor.model.Utils;
import com.epiphany.jextractor.model.VideoDetails;
import com.epiphany.jextractor.model.formats.AudioFormat;
import com.epiphany.jextractor.model.formats.AudioVideoFormat;
...
public class DefaultParser implements Parser {
    ...
    private void loadPlaylistContinuation(String continuation, String ctp, List<PlaylistVideoDetails> videos, String clientVersion) throws YoutubeException {
        ...
        getExtractor().setRequestProperty("Content-Type", "application/json");
        ...
        String html = getExtractor().loadUrl(url, data.toJSONString(), "POST");
